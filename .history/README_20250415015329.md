# Calendar App for Office Scheduling

This is a custom-built calendar application developed using **Microsoft PowerApps**. The app serves as an intuitive scheduling tool, designed for managing events in an office environment. It enables users to view, schedule, and manage events in a calendar format. This README provides a detailed description of the app's features and its usage.
